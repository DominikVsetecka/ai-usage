...
- `2026-06-24` — Claude reset-Zeit Fix: `normalizeTerminalOutput` expandiert jetzt `\x1B[NC` Cursor-Forward-Sequenzen zu echten Leerzeichen, damit „Resets Jun 30 at 9pm (Europe/Vienna)" nicht als „ResetsJun30at9pm(…)" angezeigt wird. Weekly-Reset fällt auf Session-Reset zurück wenn beide identisch (gleiches Reset-Datum). Debug-Prints aus `AIUsageSnapshot/main.swift` entfernt.
